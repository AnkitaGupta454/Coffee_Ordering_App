...
public class MainActivity extends AppCompatActivity {
    ...
    public void increment(View view)
    {
        if(quantity==100)
        {
            Toast.makeText(MainActivity.this, "You cannot order coffee more than 100",
    ...
    public void decrement(View view)
    {
        if(quantity==1)
        {
            Toast.makeText(MainActivity.this, "You cannot order coffee less than 1",
                    Toast.LENGTH_LONG).show();
        }
        else {
            quantity = quantity - 1;
...
public void submitOrder(View view) {
    // Get user's name
    EditText nameField = (EditText) findViewById(R.id.InputName);
